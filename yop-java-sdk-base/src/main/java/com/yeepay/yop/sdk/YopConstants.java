...
public interface YopConstants {
    ...
    String YOP_CREDENTIALS_ENCRYPT_ALG_RSA = RSA;
    String YOP_CREDENTIALS_DEFAULT_ENCRYPT_ALG = YOP_CREDENTIALS_ENCRYPT_ALG_SM2;
    String YOP_ENCRYPT_OPTIONS_YOP_PLATFORM_CERT_SERIAL_NO = "YOP_PLATFORM_CERT_SERIAL_NO";
    ...
    @Deprecated
    String DEFAULT_PROVIDER = "yeepay";
