...
public class AuthorizationReqSupport {
    ...
    static {
        ...
        CERT_SUPPORTED_AUTH_REQS = new HashMap<CertTypeEnum, AuthorizationReq>();final AuthorizationReq sm2 = AuthorizationReq.Builder.anAuthorizationReq().withSignerType(SignerTypeEnum.SM2)
