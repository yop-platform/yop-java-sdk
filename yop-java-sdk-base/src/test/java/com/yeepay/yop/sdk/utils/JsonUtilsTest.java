...
public class JsonUtilsTest {
    ...
    public void testReport() throws IOException {
        ...
        final String reportStr = JsonUtils.toJsonString(newObj);

        final YopHostRequestReport loaded = new YopHostRequestReport();
        JsonUtils.load(reportStr, loaded);

        Assert.assertEquals(reportStr, JsonUtils.toJsonString(loaded));
    }
}
