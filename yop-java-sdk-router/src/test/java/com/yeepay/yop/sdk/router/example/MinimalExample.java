 ...
 * Company: 易宝支付(YeePay)
 */
package com.yeepay.yop.sdk.router.example;
...
import com.yeepay.yop.sdk.router.SimpleUriResourceRouteClient;
...
public class MinimalExample {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MinimalExample.class);
    ...
    private static final SimpleUriResourceRouteClient ROUTE_CLIENT = new SimpleUriResourceRouteClient(
            Lists.newArrayList("https://baidu.com", "https://google.com"));

    // 2、提供业务调用逻辑(简单示例：出参为String)
    // 2.1、入参为：待请求目标域名targetServer、当前请求上下文信息simpleContext
    // 2.2、根据需要补充自身业务处理逻辑
    // 2.3、根据情况抛出指定异常
    private static final SimpleUriResourceBusinessLogic<String> BUSINESS_LOGIC =
            new SimpleUriResourceBusinessLogic<String>() {
                ...
                public String doBusiness(UriResource targetResource, SimpleContext context) {
                    LOGGER.info("请求到：{}", targetResource.getResource());
    ...
    public static void main(String[] args) {
        final String output = ROUTE_CLIENT.route(BUSINESS_LOGIC);
