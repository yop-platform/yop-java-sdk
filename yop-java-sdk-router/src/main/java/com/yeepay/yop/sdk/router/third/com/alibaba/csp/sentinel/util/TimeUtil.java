 ...
 */
package com.yeepay.yop.sdk.router.third.com.alibaba.csp.sentinel.util;
...
import com.yeepay.yop.sdk.router.third.com.alibaba.csp.sentinel.util.function.Tuple2;
...
public final class TimeUtil implements Runnable {
    ...
    public TimeUtil() {
        this.statistics = new LeapArray<Statistic>(3, 3000) {
