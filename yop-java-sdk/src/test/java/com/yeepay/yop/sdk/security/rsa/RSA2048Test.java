...
public class RSA2048Test {
    ...
    public void name() {
        ...
        boolean verifySign = YopSignProcessorFactory.getSignProcessor("RSA2048")
                .verify(sourceData, signToBase64, new PKICredentialsItem(publicKey, CertTypeEnum.RSA2048));
