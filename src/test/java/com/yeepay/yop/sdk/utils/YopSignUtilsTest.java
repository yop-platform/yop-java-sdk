...
public class YopSignUtilsTest {
    ...
    public void testSm2Sign() {
        ...
        String signatureWithPrikey = YopSignUtils.sign(data, certType, Sm2Utils.string2PrivateKey(priKey));
    ...
    public void testVerifySm2Sign() {
        ...
        YopSignUtils.verify(data, signature, Sm2Utils.string2PublicKey(pubKey));
