...
public class Sm2SignAndVerifyTest {
    ...
    public void testSign() {
        ...
        String signature = YopSigner.getSignProcess(pkiCredentialsItem.getCertType()).sign(content, pkiCredentialsItem);
    ...
    public void testVerify() {
        ...
        YopSignProcessor yopSignProcessor = YopSigner.getSignProcess(CertTypeEnum.SM2);
