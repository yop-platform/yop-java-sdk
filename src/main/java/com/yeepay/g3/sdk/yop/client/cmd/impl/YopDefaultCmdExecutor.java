 ...
 * Company: 易宝支付(YeePay)
 */
package com.yeepay.g3.sdk.yop.client.cmd.impl;

import com.google.common.collect.Lists;
import com.yeepay.g3.sdk.yop.client.cmd.YopCmdExecutor;
...
public class YopDefaultCmdExecutor implements YopCmdExecutor {
    ...
    private static final List<String> SUPPORT_TYPES = Lists.newArrayList(CharacterConstants.ASTERISK);
    @Override
